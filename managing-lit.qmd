...
## [Reference Management Software for Surviving to Thriving]{.small}
...
-   What *is* RMS?
    ...
    -   Capable of knowledge management
...
## Scholars Need the Lowest Bar to a RMS
...
::: fragment
> Zotero \[zoh-TAIR-oh\] is a free, easy-to-use tool to help you collect, organize, cite, and share your research sources. - [Zotero's quick start guide](https://www.zotero.org/support/quick_start_guide)
:::
...
[![](images/zotero-web-account.png){fig-align="right"}](https://www.zotero.org/user/register/)
:::
...
[![](images/zotero-download.png){fig-align="right"}](https://www.zotero.org/download/)
:::
...
[![](images/zotero-connector.png){fig-align="right"}](https://www.zotero.org/download/)
:::
...
::: container
:::: col
<svg width="500" height="200"> <a href="https://play.google.com/store/apps/details?id=com.mickstarify.zooforzotero"> <rect x="10" y="10" width="480" height="180" rx="10" ry="10" fill="blue" /> <text x="50%" y="50%" text-anchor="middle" fill="white" stroke="white" stroke-width="1">Android</text> </a> </svg>
::::

:::: col
<svg width="500" height="200"> <a href="https://apps.apple.com/us/app/zotero/id1513554812"> <rect x="10" y="10" width="480" height="180" rx="10" ry="10" fill="red" /> <text x="50%" y="50%" text-anchor="middle" fill="white" stroke="white" stroke-width="1">IOS</text> </a> </svg>
::::
:::
...
-   [Zotfile](http://zotfile.com/)
    -   [Latest Release](https://github.com/jlegewie/zotfile/releases/tag/v5.1.2)
:::

::: {.column width="50%"}
-   [Better BibTeX](https://retorque.re/zotero-better-bibtex/)
    -   [Latest Release](https://github.com/retorquere/zotero-better-bibtex/releases/latest)
:::
:::
:::

## Install the add-ons to complete the extenstion
...
## [Configure Zotero for limitless, well-organized storage]{.small}
...
1.  Download and install [Drive for Desktop](https://www.google.com/drive/download/)
2.  Skip everything
...
6.  In secondary computer,
    i.  Download, install, and sync [Drive for Desktop](https://www.google.com/drive/download/)
    ii. Allow `Offline access` to `zotero-library` for local storage
    iii. Repeat the Install & Setup section until this point - BUT! Replace the `zotero-library` path with the Google Drive `zotero-library` path
...
[Zotfile has trouble with html currently. A solution:](https://github.com/jlegewie/zotfile/issues/566)
...
Follow the [instructions for popular tool](https://www.zotero.org/support/moving_to_zotero)
...
-   Addons
    ...
    -   [This issue](https://github.com/ethanwillis/zotero-scihub/issues/96#issuecomment-1758310741) for [Action tags](https://github.com/windingwind/zotero-actions-tags/discussions/124) ([requires Z7](https://github.com/zotero/zotero/milestone/9))
-   External
...
For automatic tagging, install the [Actions and Tags](https://github.com/windingwind/zotero-actions-tags) addon
...
-   [Style](https://github.com/MuiseDestiny/zotero-style#readme)
-   [References](https://github.com/MuiseDestiny/zotero-reference)
...
-   [Translate](https://github.com/windingwind/zotero-pdf-translate#readme)

Integrated external tools:

-   [Research Rabbit](https://www.researchrabbit.ai/)
-   [An AI Assistant?](https://forums.zotero.org/discussion/102320/the-possibility-of-integrating-ai-into-zotero-to-assist-reading/p1)
